  ...
  <div class="navbar-menu-wrapper grow d-flex align-items-stretch">
    ...
    <ul class="navbar-nav navbar-nav-right">
      <li class="nav-item d-none d-lg-block">
        <a class="nav-link btn btn-success create-new-button" id="createbuttonToggle" data-bs-toggle="offcanvas" data-bs-target="#createNewProject" aria-controls="createNewProject" href="#">+ Create New Project</a>
      </li>
